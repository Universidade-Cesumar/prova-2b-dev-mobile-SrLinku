...
Modernizar o controle de insumos médicos do almoxarifado por meio de uma interface mobile conectada a uma API. O sistema permite consultar o inventário em tempo real e cadastrar novos materiais de forma simples e segura.
...
- Exibição dos materiais em `FlatList` com nome e quantidade
